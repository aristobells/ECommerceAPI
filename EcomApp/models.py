...
class Product(models.Model):
 ...
 image = CloudinaryField("product_img", folder = "EcomerceProductimg",blank = True, null=True)
...
class ProductImage(models.Model):
  ...
  photos = CloudinaryField("product_img", folder = "otherImg",blank = True, null=True)
